...
void main()
{
  ...
  {
    test('Test0', () { expect( checkSubnetAddresses(['128.64.0.0/23', '128.64.2.0/26', '128.64.3.0/28'], '128.64.0.0/22'),
                               equals([true, true, true]) ); });

    test('Test1', () { expect( checkSubnetAddresses(['128.64.0.0/23', '128.64.1.0/26', '128.64.3.0/28'], '128.64.0.0/22'),
                               equals([false, true, true]) ); });

    test('Test2', () { expect( checkSubnetAddresses(['0.0.0.0/23', '128.64.1.0/26', '128.64.3.0/28'], '128.64.0.0/22'),
                               equals([false, true, true]) ); });

    test('Test3', () { expect( checkSubnetAddresses(['128.64.0.0/23', '128.64.2.0/26', '128.64.3.0/28',
                                                     '128.64.2.64/26, 128.64.3.128/28'], '128.64.0.0/22'),
                               equals([true, true, true, true]) ); });

    test('Test4', () { expect( checkSubnetAddresses(['192.64.16.8/18', '192.65.16.8/22'], '192.64.0.0/16'),
                               equals([true, false]) ); });

    test('Test5', () { expect( checkSubnetAddresses(['192.65.16.8/18', '192.65.16.8/22'], '192.65.0.0/16'),
                               equals([false, true]) ); });
  });
}